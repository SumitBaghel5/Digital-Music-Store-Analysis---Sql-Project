...
# Objective - This project analyze the music playlist database and help the store understand its business growth.
...
WHERE milliseconds > ( Select avg(milliseconds) as avg_track_length
 ...
 # Q10 - We want to find out the most popular music Genre for each country. We determine the most popular genere
